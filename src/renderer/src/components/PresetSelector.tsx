...
const PRESETS: Array<{
...
}> = [
  {
    ...
    detail: 'Raises game CPU priority to Above Normal. Safest choice — minimal intervention, zero side effects.',
    game: 'Above Normal',
    bg: 'Normal',
    mmcss: 'Disabled',
    features: [],
  ...
  },
  {
    ...
    detail: 'Everything in Normal plus stricter MMCSS CPU Limit (14% for background) and game child process protection.',
    game: 'High',
    bg: 'Normal',
    mmcss: 'Games (14% BG CPU)',
    features: ['0.5 ms Timer', 'MMCSS Games Profile', 'Strict MMCSS CPU Limit', 'Child Process Shield'],
    missing: [],
